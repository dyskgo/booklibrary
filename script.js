 ...
 let catcher = new book('Catcher in the Rye', 'J.D Salinger', '203', 'not'); 
 let slaughterhouse = new book('Slaughterhouse-5', 'Kurt Vonnegut', '200', 'not');
 let clockwork = new book('A Clockwork Orange', 'Anthony Burgess', '188', 'not');
 myLibrary.push(catcher);
 myLibrary.push(slaughterhouse)
 myLibrary.push(clockwork);
 render(myLibrary);